read -p "Enter CPIMS DB name: " cpimsdb
read -p "Enter CPIMS DB user: " cpimsdbuser



echo "< ================= Merge queries started ================= "
...
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_person_01.sql

echo "< 002 (b): import DCS auth_user ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_auth_user_01.sql

echo "< 002 (c): import DCS reg_org_unit, reg_org_units_geo ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_org_units_01.sql

echo "< 002 (d): import DCS reg_person_geo, reg_persons_org_units, reg_persons_external_ids, reg_persons_audit_trail ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_person_02.sql
#--
echo "< 002 (e): import DCS reg_org_units_audit_trail ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_org_units_02.sql

echo "< 002 (f): import DCS reg_person_master, reg_persons_guardians, reg_persons_siblings, reg_persons_types ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_person_03.sql
...
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_ovc_case_records.sql
...
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_ovc_metadata_01.sql

echo "< 002 (i): import DCS reg_household ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_household.sql

echo "< 002 (j): import DCS reg_org_units_contact, reg_org_units_external_ids ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_reg_org_units_03.sql

echo "< 002 (k): import DCS auth_user_groups, auth_user_user_permissions, auth_user_groups_geo_org ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_auth_user_02.sql

echo "< 002 (l): import DCS django_content_type ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_django_content_type.sql

echo "< 002 (m): import DCS forms_audit_trail, forms_log ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_forms.sql

echo "< 002 (n): import DCS list_general ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_list_general.sql

echo "< 002 (o): import DCS ovc_bursaryinfo, ovc_adverseevents_followup, ovc_adverseevents_other_followup, ovc_economic_status ..."
psql -h localhost  $cpimsdb  $cpimsdbuser -a -w -f append_data/append_ovc_metadata_02.sql
