...
ALTER TABLE auth_user ADD CONSTRAINT auth_user_reg_person_id_a5c91cbe2cfbe65_fk_reg_person_id FOREIGN KEY (reg_person_id) REFERENCES auth_user(id) ON UPDATE CASCADE ON DELETE CASCADE;
